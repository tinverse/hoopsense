...
CATEGORY_SIGNAL_MAP = {
    ...
    "live_play_context": [
        "live_play_label",
        "live_play_score",
        "live_play_segment_label",
        "live_play_segment_duration_ms",
        "ball_signal_present",
        "ball_confidence",
        "active_candidate_count",
        "motion_speed_max",
...
def summarize_frame(frame: dict) -> dict:
    ...
    return {
        ...
        "live_play_score": frame.get("live_play_score"),
        "live_play_label": frame.get("live_play_label"),
        "live_play_segment_label": frame.get("live_play_segment_label"),
        "live_play_segment_duration_ms": frame.get("live_play_segment_duration_ms"),
        "ball_signal_present": (frame.get("live_play_reasons") or {}).get("ball_signal_present"),
        "ball_confidence": (frame.get("live_play_reasons") or {}).get("ball_confidence"),
...
def build_report(fixture: dict, artifact_dir: Path, fixture_path: Path) -> dict:
    ...
    return {
        ...
        "limitations": [
            ...
            "Ball detections are a minimal single-frame artifact in v1; they are not yet a stable tracker or possession signal.",
